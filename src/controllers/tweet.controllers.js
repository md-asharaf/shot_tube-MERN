...
class TweetC {
    ...
    static createTweet = asyncHandler(async (req, res) => {
    ...
    static updateTweet = asyncHandler(async (req, res) => {
    ...
    static deleteTweet = asyncHandler(async (req, res) => {
        const { tweetId } = req.params;
        const userId = req.user?._id;
        if (!tweetId || !userId) {
    ...
    static getUserTweets = asyncHandler(async (req, res) => {
